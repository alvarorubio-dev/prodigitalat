    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="flex items-center gap-2 bg-amber-400/10 border border-amber-400/30 text-amber-300 text-sm font-bold px-5 py-2 rounded-full"
          >
          ...
          >
            Tu competencia ya tiene web y ya está recibiendo tus clientes. Cada
            día que esperas es dinero que pierdes.
          </motion.p>

          <motion.ul
            variants={fadeInUp}
            className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-left"
          ...
          >
            <button
              ...
              className="group flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#1ebe5d] active:bg-[#18a850] text-white font-black text-xl px-10 py-5 rounded-2xl transition-all duration-200 shadow-2xl shadow-green-900/40 hover:shadow-green-900/60 hover:-translate-y-1 active:translate-y-0 cursor-pointer"
            >
