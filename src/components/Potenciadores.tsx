    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Estos complementos <strong className="text-slate-700">NO son obligatorios</strong>.
            Escala tu presencia online en Estados Unidos. Tu Página Web para contractors ya incluye el diseño de alta conversión para generar llamadas,              pero puedes sumar estas herramientas de posicionamiento en Google e idiomas para dominar tu ciudad.
          </motion.p>
        </motion.div>
            ...
            >
              {featured && (
                <div className="absolute -top-3 left-5">
                  <span className="inline-flex items-center gap-1 bg-brand-orange text-white text-xs font-black px-3 py-1 rounded-full shadow-md">
                    <Star className="w-3 h-3" aria-hidden="true" fill="currentColor" />
                    Recomendado
                  </span>
                </div>
              )}
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-navy font-bold text-sm leading-snug">{title}</h3>
                  <p className="text-brand-orange font-black text-lg mt-0.5">{price}</p>
                </div>
              </div>
              ...
              <a
                ...
                className={`inline-flex items-center justify-center gap-2 w-full py-2.5 rounded-xl text-sm font-bold transition-all duration-200 border ${
                  featured
