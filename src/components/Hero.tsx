...
import { ShieldCheck, Zap, Globe, Star, TrendingUp, Phone, CheckCircle } from 'lucide-react';
    ...
    <div className="relative flex items-center justify-center" aria-hidden="true">
        ...
        <div className="absolute inset-[3px] bg-gradient-to-b from-slate-900 to-navy-800 rounded-[2.8rem] overflow-hidden">
          ...
          <div className="pt-8 px-3 h-full flex flex-col gap-2">
            <div className="bg-gradient-to-r from-brand-orange to-orange-400 rounded-xl p-3 text-white">
              <div className="text-[9px] font-black uppercase tracking-wide opacity-80">MARTINEZ ROOFING CO.</div>
              <div className="text-[13px] font-black leading-tight mt-1">Roofing Experts<br />You Can Trust</div>
              <div className="flex items-center gap-1 mt-2">
                <div className="bg-white/20 rounded-md px-2 py-1 text-[8px] font-semibold">Free Estimate</div>
                <div className="bg-white rounded-md px-2 py-1 text-[8px] font-bold text-brand-orange">Call Now</div>
              </div>
            </div>
            <div className="bg-white/5 rounded-xl p-3 border border-white/10">
              <div className="flex gap-2 items-start">
                ...
                <div>
                  <div className="text-[9px] font-bold text-white">5.0 Google Reviews</div>
                  <div className="text-[8px] text-slate-400 mt-0.5">"Best roofer in Dallas!"</div>
                </div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                <div key={label} className="bg-white/5 border border-white/10 rounded-lg p-2 flex flex-col items-center gap-1">
                  ...
                  <span className="text-[8px] text-slate-300 font-medium">{label}</span>
                </div>
              ))}
            </div>
            <div className="flex-1 bg-white/5 rounded-xl p-3 border border-white/10">
              <div className="text-[9px] text-slate-400 font-medium mb-2">Our Work</div>
              <div className="grid grid-cols-3 gap-1">
                {[
                  ...
                  <div key={i} className={`h-12 bg-gradient-to-br ${gradient} rounded-lg opacity-70`} />
                ))}
              </div>
            </div>
            <div className="flex items-center gap-2 bg-green-500/20 border border-green-500/30 rounded-xl p-2.5 mb-1">
              ...
              <div>
                <div className="text-[9px] font-bold text-green-300">WhatsApp Direct</div>
                <div className="text-[8px] text-slate-400">Contacta al instante</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="absolute -top-4 -right-6 bg-white rounded-2xl shadow-2xl px-4 py-2.5 border border-slate-100">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-slate-800">+14 llamadas esta semana</span>
        </div>
      </div>
      ...
      <div className="absolute -bottom-2 -left-6 bg-navy rounded-2xl shadow-2xl px-4 py-2.5 border border-white/10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-white">Listo en <span className="text-brand-orange">72 horas</span></span>
        </div>
      </div>
    </div>
  );
...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-navy overflow-hidden flex items-center" aria-labelledby="hero-heading">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-brand-orange font-semibold">Todo por WhatsApp, en español, sin reuniones.</span>
            </motion.p>

            <motion.ul variants={fadeInUp} className="flex flex-col gap-3" aria-label="Beneficios principales">
              {[
                'Sin reuniones — todo por WhatsApp, en tu idioma',
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                aria-label="Hablar por WhatsApp para empezar mi página web"
                className="group flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#1ebe5d] active:bg-[#18a850] text-white font-black text-lg px-8 py-4 rounded-2xl transition-all duration-200 shadow-2xl shadow-green-900/40 hover:shadow-green-900/60 hover:-translate-y-1 active:translate-y-0"
              >
            ...
            <motion.div variants={fadeInUp} className="flex flex-col gap-2 pt-1">
              ...
              <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
                {[
                  ...
                  <div key={text} className="flex items-center gap-1.5 text-slate-400 text-sm font-medium">
