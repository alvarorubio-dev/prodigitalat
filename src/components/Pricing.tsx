...
const features = [
  ...
  {
    icon: MessageCircle,
    text: "Botón de WhatsApp integrado para contacto directo",
  },
  { icon: Mail, text: "Formulario de contacto directo a tu correo" },
  {
    icon: FileText,
    text: 'Copywriting persuasivo en inglés + sello "Se Habla Español"',
  },
  {
    icon: Globe,
    text: "Dominio + Hosting incluidos el 1er año (renovación: $99/año después).",
  },
  { icon: Mail, text: "1 Correo corporativo (ej: info@tunegocio.com)" },
  { icon: ShieldCheck, text: "Certificado de seguridad SSL incluido" },
];

export default function Pricing({ onOpenChat }: { onOpenChat: () => void }) {
        ...
        >
          ...
          >
            ...
            <span className="text-gradient">
              Tu Página Genera Llamadas Todo el Año.
            </span>
          </motion.h2>
          <motion.p
            variants={fadeInUp}
          ...
          >
            Cero costos ocultos. Pagas una sola vez y la web, el dominio y el
            hosting son tuyos al 100%. Tu negocio, tu propiedad.
          </motion.p>
        </motion.div>
            ...
            <div className="relative bg-white rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <div className="flex items-center gap-2 flex-wrap mb-1">
                      <span
                        className="text-white/50 text-xl font-bold line-through"
                        aria-label="Precio original $897"
                      >
                        $897
                      </span>
                      <span
                        className="text-white text-xs font-black px-2 py-1 rounded-full uppercase tracking-wide"
                    ...
                    <div className="flex items-baseline gap-2 flex-wrap">
                      <span
                        ...
                        aria-label="Precio especial $399"
                      >
                        $399
                      </span>
                    ...
                    <div className="text-orange-100 text-sm mt-1">
                      Pago único · Sin contratos mensuales
                    </div>
                  </div>
              ...
              <div className="px-8 py-7">
                ...
                <button
                  ...
                  className="group flex items-center justify-center gap-2.5 w-full bg-navy hover:bg-slate-800 active:bg-slate-900 text-white font-black text-lg py-4 rounded-2xl transition-all duration-200 shadow-xl shadow-navy/30 hover:shadow-navy/50 hover:-translate-y-0.5 cursor-pointer"
                >
                ...
                <div className="mt-5 bg-amber-50 border border-amber-200 rounded-2xl p-4 text-center">
                  <p className="text-amber-800 text-sm font-bold">
                    Cero Riesgo: Pagas el 50% para arrancar, y el 50% restante
                    SOLO cuando veas tu página terminada y te encante.
                  </p>
                </div>
              </div>
            </div>
